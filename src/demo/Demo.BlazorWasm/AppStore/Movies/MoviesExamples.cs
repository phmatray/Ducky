...
public static class MoviesExamples
{
    public static readonly Movie Movie01 = new()
    {
        ...
        Actors = ImmutableArray.Create("Tom Hanks", "Robin Wright", "Gary Sinise")
    };
    ...
    public static readonly Movie Movie02 = new()
    {
        ...
        Actors = ImmutableArray.Create("Tim Robbins", "Morgan Freeman", "Bob Gunton")
    };
    ...
    public static readonly Movie Movie03 = new()
    {
        ...
        Actors = ImmutableArray.Create("Logan Lerman", "Emma Watson", "Ezra Miller")
    };
    ...
    public static readonly Movie Movie04 = new()
    {
        ...
        Actors = ImmutableArray.Create("Christian Bale", "Heath Ledger", "Aaron Eckhart")
    };
    ...
    public static readonly Movie Movie05 = new()
    {
        ...
        Actors = ImmutableArray.Create("Angelina Jolie", "Colm Feore", "Amy Ryan")
    };
    ...
    public static readonly Movie Movie06 = new()
    {
        ...
        Actors = ImmutableArray.Create("Robert De Niro", "Leonardo DiCaprio", "Ellen Barkin")
    };
    ...
    public static readonly Movie Movie07 = new()
    {
        ...
        Actors = ImmutableArray.Create("James Stewart", "Donna Reed", "Lionel Barrymore")
    };
    ...
    public static readonly Movie Movie08 = new()
    {
        ...
        Actors = ImmutableArray.Create("Jodie Foster", "Anthony Hopkins", "Scott Glenn")
    };
    ...
    public static readonly Movie Movie09 = new()
    {
        ...
        Actors = ImmutableArray.Create("Eminem", "Brittany Murphy", "Kim Basinger")
    };
    ...
    public static readonly Movie Movie10 = new()
    {
        ...
        Actors = ImmutableArray.Create("Emilio Estevez", "Judd Nelson", "Molly Ringwald")
    };
    ...
    public static readonly Movie Movie11 = new()
    {
        ...
        Actors = ImmutableArray.Create("Jamie Foxx", "Christoph Waltz", "Leonardo DiCaprio")
    };
    ...
    public static readonly Movie Movie12 = new()
    {
        ...
        Actors = ImmutableArray.Create("Bradley Cooper", "Jennifer Lawrence", "Robert De Niro")
    };
    ...
    public static readonly Movie Movie13 = new()
    {
        ...
        Actors = ImmutableArray.Create("Jack Nicholson", "Shelley Duvall", "Danny Lloyd")
    };
    ...
    public static readonly Movie Movie14 = new()
    {
        ...
        Actors = ImmutableArray.Create("Morgan Freeman", "Brad Pitt", "Kevin Spacey")
    };
    ...
    public static readonly Movie Movie15 = new()
    {
        ...
        Director = "Sam Mendes",
        Actors = ImmutableArray.Create("Kevin Spacey", "Annette Bening", "Thora Birch")
    };
    ...
    public static readonly Movie Movie16 = new()
    {
        ...
        Director = "Quentin Tarantino",
        Actors = ImmutableArray.Create("John Travolta", "Uma Thurman", "Samuel L. Jackson")
    };
    ...
    public static readonly Movie Movie17 = new()
    {
        ...
        Actors = ImmutableArray.Create("Jessica Chastain", "Joel Edgerton", "Chris Pratt")
    };
    ...
    public static readonly Movie Movie18 = new()
    {
        ...
        Actors = ImmutableArray.Create("Ben Affleck", "Bryan Cranston", "John Goodman")
    };
    ...
    public static readonly Movie Movie19 = new()
    {
        ...
        Director = "Kathryn Bigelow",
        Actors = ImmutableArray.Create("Jeremy Renner", "Anthony Mackie", "Brian Geraghty")
    };
    ...
    public static readonly Movie Movie20 = new()
    {
        ...
        Actors = ImmutableArray.Create("Marlon Brando", "Al Pacino", "James Caan")
    };
    ...
    public static readonly Movie Movie21 = new()
    {
        ...
        Director = "Ben Affleck",
        Actors = ImmutableArray.Create("Ben Affleck", "Rebecca Hall", "Jon Hamm")
    };
    ...
    public static readonly Movie Movie22 = new()
    {
        ...
        Actors = ImmutableArray.Create("Leonardo DiCaprio", "Matt Damon", "Jack Nicholson")
    };
    ...
    public static readonly Movie Movie23 = new()
    {
        ...
        Director = "Wes Craven",
        Actors = ImmutableArray.Create("Neve Campbell", "Courteney Cox", "David Arquette")
    };
    ...
    public static readonly Movie Movie24 = new()
    {
        ...
        Actors = ImmutableArray.Create("George Clooney", "Vera Farmiga", "Anna Kendrick")
    };
    ...
    public static readonly Movie Movie25 = new()
    {
        ...
        Actors = ImmutableArray.Create("Johnny Depp", "Leonardo DiCaprio", "Juliette Lewis")
    };
    ...
    public static readonly Movie Movie26 = new()
    {
        ...
        Actors = ImmutableArray.Create("Bill Murray", "Scarlett Johansson", "Giovanni Ribisi")
    };
    ...
    public static readonly Movie Movie27 = new()
    {
        ...
        Director = "James Wan",
        Actors = ImmutableArray.Create("Patrick Wilson", "Vera Farmiga", "Ron Livingston")
    };
    ...
    public static readonly Movie Movie28 = new()
    {
        ...
        Director = "Jason Reitman",
        Actors = ImmutableArray.Create("Elliot Page", "Michael Cera", "Jennifer Garner")
    };
    ...
    public static readonly Movie Movie29 = new()
    {
        ...
        Director = "Rob Reiner",
        Actors = ImmutableArray.Create("Wil Wheaton", "River Phoenix", "Corey Feldman")
    };
    ...
    public static readonly Movie Movie30 = new()
    {
        ...
        Director = "Frank Darabont",
        Actors = ImmutableArray.Create("Tom Hanks", "Michael Clarke Duncan", "David Morse")
    };
    ...
    public static readonly Movie Movie31 = new()
    {
        ...
        Director = "J.J. Abrams",
        Actors = ImmutableArray.Create("Elle Fanning", "AJ Michalka", "Kyle Chandler")
    };
    ...
    public static readonly Movie Movie32 = new()
    {
        ...
        Director = "Sam Mendes",
        Actors = ImmutableArray.Create("Jake Gyllenhaal", "Jamie Foxx", "Lucas Black")
    };
    ...
    public static readonly Movie Movie33 = new()
    {
        ...
        Director = "Rob Reiner",
        Actors = ImmutableArray.Create("James Caan", "Kathy Bates", "Richard Farnsworth")
    };
    ...
    public static readonly Movie Movie34 = new()
    {
        ...
        Director = "David Fincher",
        Actors = ImmutableArray.Create("Brad Pitt", "Edward Norton", "Meat Loaf")
    };
    ...
    public static readonly Movie Movie35 = new()
    {
        ...
        Director = "Martin Scorsese",
        Actors = ImmutableArray.Create("Leonardo DiCaprio", "Emily Mortimer", "Mark Ruffalo")
    };
    ...
    public static readonly Movie Movie36 = new()
    {
        ...
        Actors = ImmutableArray.Create("Tom Hardy", "Shia LaBeouf", "Guy Pearce")
    };
    ...
    public static readonly Movie Movie37 = new()
    {
        ...
        Actors = ImmutableArray.Create("Jennifer Lawrence", "John Hawkes", "Garret Dillahunt")
    };
    ...
    public static readonly Movie Movie38 = new()
    {
        ...
        Director = "Martin Scorsese",
        Actors = ImmutableArray.Create("Robert De Niro", "Jodie Foster", "Cybill Shepherd")
    };
    ...
    public static readonly Movie Movie39 = new()
    {
        ...
        Actors = ImmutableArray.Create("Tom Hanks", "Matt Damon", "Tom Sizemore")
    };
    ...
    public static readonly Movie Movie40 = new()
    {
        ...
        Actors = ImmutableArray.Create("Natalie Portman", "Mila Kunis", "Vincent Cassel")
    };
    ...
    public static readonly Movie Movie41 = new()
    {
        ...
        Director = "Christopher Nolan",
        Actors = ImmutableArray.Create("Leonardo DiCaprio", "Joseph Gordon-Levitt", "Elliot Page")
    };
    ...
    public static readonly Movie Movie42 = new()
    {
        ...
        Actors = ImmutableArray.Create("Mark Wahlberg", "Julianne Moore", "Burt Reynolds")
    };
    ...
    public static readonly Movie Movie43 = new()
    {
        ...
        Actors = ImmutableArray.Create("Joseph Gordon-Levitt", "Seth Rogen", "Anna Kendrick")
    };
    ...
    public static readonly Movie Movie44 = new()
    {
        ...
        Actors = ImmutableArray.Create("Jake Gyllenhaal", "Natalie Portman", "Tobey Maguire")
    };
    ...
    public static readonly Movie Movie45 = new()
    {
        ...
        Actors = ImmutableArray.Create("Leonardo DiCaprio", "Djimon Hounsou", "Jennifer Connelly")
    };
    ...
    public static readonly Movie Movie46 = new()
    {
        ...
        Director = "Rob Reiner",
        Actors = ImmutableArray.Create("Tom Cruise", "Jack Nicholson", "Demi Moore")
    };
    ...
    public static readonly Movie Movie47 = new()
    {
        ...
        Actors = ImmutableArray.Create("Russell Crowe", "Joaquin Phoenix", "Connie Nielsen")
    };
    ...
    public static readonly Movie Movie48 = new()
    {
        ...
        Actors = ImmutableArray.Create("Gerard Butler", "Jamie Foxx", "Leslie Bibb")
    };
    ...
    public static readonly Movie Movie49 = new()
    {
        ...
        Actors = ImmutableArray.Create("Samuel L. Jackson", "Patrick Wilson", "Kerry Washington")
    };
    ...
    public static readonly Movie Movie50 = new()
    {
        ...
        Actors = ImmutableArray.Create("Josh Lucas", "Derek Luke", "Austin Nichols")
    };
