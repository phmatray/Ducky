...
public static class CustomOperators
{
    ...
    public static IObservable<TAction> OfActionType<TAction>(
        this IObservable<object> source)
    {
        return source.OfType<TAction>();
    }
    ...
    public static IObservable<object> SelectAction<TSource, TResult>(
    ...
    public static IObservable<TSource> CatchAction<TSource>(
        this IObservable<TSource> source,
        Func<Exception, TSource> selector)
    {
        return source.Catch<TSource, Exception>(ex => Observable.Return(selector(ex)));
    }
