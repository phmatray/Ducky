...
//
// /// <inheritdoc />
// public abstract class AsyncEffect<TAction> : IAsyncEffect, IAsyncEffect<TAction>
// {
...
//     public abstract Task HandleAsync(TAction action, IRootState rootState, IDispatcher dispatcher);
//
//     /// <inheritdoc />
