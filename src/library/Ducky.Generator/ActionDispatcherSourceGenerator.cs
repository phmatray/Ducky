...
public class ActionDispatcherSourceGenerator : SourceGeneratorBase
{
    ...
    public override void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterPostInitializationOutput(ctx =>
            ctx.AddSource("DuckyActionAttribute.g.cs", SourceText.From(AttributeSourceCode, System.Text.Encoding.UTF8)));
        ...
        in SourceProductionContext context)
    {
        foreach (RecordDeclarationSyntax recordSyntax in records)
        {
            ...
            // Use IndentedStringBuilder to build the source file content.
            ...
            for (int i = 0; i < parameterLines.Count; i++)
            {
                ...
                sb.AppendLine($"        {parameterLines[i]}{comma}");
            }
