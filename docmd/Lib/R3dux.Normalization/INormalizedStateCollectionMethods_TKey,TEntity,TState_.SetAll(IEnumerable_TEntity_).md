...
## INormalizedStateCollectionMethods<TKey,TEntity,TState>.SetAll(IEnumerable<TEntity>) Method

Replaces the current collection with the provided collection.

```csharp
TState SetAll(System.Collections.Generic.IEnumerable<TEntity> entities);
```
#### Parameters

<a name='R3dux.INormalizedStateCollectionMethods_TKey,TEntity,TState_.SetAll(System.Collections.Generic.IEnumerable_TEntity_).entities'></a>
