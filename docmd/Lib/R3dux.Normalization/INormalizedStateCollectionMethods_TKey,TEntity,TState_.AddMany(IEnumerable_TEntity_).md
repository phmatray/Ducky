...
## INormalizedStateCollectionMethods<TKey,TEntity,TState>.AddMany(IEnumerable<TEntity>) Method

Adds multiple entities to the collection.

```csharp
TState AddMany(System.Collections.Generic.IEnumerable<TEntity> entities);
```
#### Parameters

<a name='R3dux.INormalizedStateCollectionMethods_TKey,TEntity,TState_.AddMany(System.Collections.Generic.IEnumerable_TEntity_).entities'></a>
